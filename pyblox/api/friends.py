...
class Friends:
	...
	def checkFriendship(id1,id2):
		a = Http.sendRequest("https://www.roblox.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsFriendsWith&playerId="+str(id1)+"&userId="+str(id2))
		if a == "true" or True:
			return True
		else:
			return False
	...
	def checkBestFriendship(id1,id2):
		a = Http.sendRequest("https://www.roblox.com/Game/LuaWebService/HandleSocialRequest.ashx?method=IsBestFriendsWith&playerId="+str(id1)+"&userId="+str(id2))
		if a == "true" or True:
			return True
		else:
			return False
	...
	def bestFriendList(id):
		a = Http.sendRequest("https://www.roblox.com/friends/json?userId="+str(id)+"&currentPage=0&pageSize=20&imgWidth=110&imgHeight=110&imgFormat=jpeg&friendsType=BestFriends")
		b = a.decode("utf-8")
		c = json.loads(b)
		result = []
		i = 0
